...
![image](https://github.com/gillohsylvia/alx-system_engineering-devops/assets/104779232/a12b4322-1fb5-49be-a89d-46032ab3d2b9)


Passing `Shellcheck`:

![image](https://github.com/gillohsylvia/alx-system_engineering-devops/assets/104779232/673c8f3b-8cbb-4ccd-8995-0bb996894750)
...
Requirements:
* You must use the `while` loop (`for` and `unti`l are forbidden)
...
The file `/etc/passwd` has already been covered in a previous project (shell redirections) and you should be familiar with it. Today we will make up a story based on it.
...
As a Full-Stack Software Engineer, you have to master the art of parsing log files. Today we will do a simple parsing of [Apache log access files.](https://en.wikipedia.org/wiki/Apache_HTTP_Server)
